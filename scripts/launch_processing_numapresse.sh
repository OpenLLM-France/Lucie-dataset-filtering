...
DIR_DATASET=/scratch/openllm/data/numapresse
DIR_OUTPUT=/scratch/openllm/data/numapresse_processed
...
--mapping_fields '{"raw_content": "text"}' \
--default_fields '{"source_domain": "numapresse.org"}' \
--fields_to_keep '["issue", "page", "work","date"]' \
--language 'fr' \
--n_processes 64 \
--flush-freq 1000 \
